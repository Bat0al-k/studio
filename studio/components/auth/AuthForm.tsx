    ...
    return (
        <div className="space-y-2">
            ...
            <div className="relative">
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-[#082D47] dark:focus:ring-[#306C96] bg-white/80 backdrop-blur-sm transition-all text-[#0f2d44] "
                />
                <button
                type="button"
        ...
        <>
            <form className="space-y-5">
                ...
                <div className="pt-4 space-y-4 flex flex-col gap-2 text-center">
                    <Link href="/" className="w-full bg-[#082D47] border border-white text-white font-bold py-4 rounded-xl hover:bg-[#082D47B2] transition-colors shadow-lg">
                        {isSignup ? "Sign up" : "Login"}
                    </Link>

                    <Link href="/" className="w-full bg-white border border-gray-300 text-[#0a2540] hover:text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#082D47B2] transition-colors duration-200 shadow-lg">
