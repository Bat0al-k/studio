...
export interface StudioBlock {
  ...
  volume?: number;
  playbackRate?: number;
  isMuted?: boolean;   // [Audio Inspector] Mute toggle
  fadeIn?: number;     // [Audio Inspector] Fade in duration (seconds)
  fadeOut?: number;    // [Audio Inspector] Fade out duration (seconds)
}
...
export interface TimelineItem {
  ...
  url?: string; // Explicit URL for PreviewPlayer
...
export interface TimelineLayer {
  id: string; // UUID
  type: 'visual' | 'audio' | 'text'; // [FIX] Added 'text' for text layer
